...
import { ThemeProvider } from './features/common/theme/theme-provider';
import { useTheme } from './features/common/theme/use-theme';
...
const ThemedAntdProvider = ({ children }: { children: React.ReactNode }) => {
  const { resolved } = useTheme();
  return <ConfigProvider theme={getThemeConfig(resolved)}>{children}</ConfigProvider>;
};
