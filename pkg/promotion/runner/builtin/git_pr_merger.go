...
func (g *gitPRMerger) run(
	...
	if err != nil {
		// Some merge failures are transient and a subsequent reconciliation
		// will succeed once the upstream condition clears. Return a
		// non-terminal error for those so the orchestrator's
